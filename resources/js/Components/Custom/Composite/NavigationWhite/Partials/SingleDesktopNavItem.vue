  ...
  <div>
    ...
    <div v-if="!('subMenu' in navigationItem)">
      <InertiaLink :href="navigationItem.url">
        <div
          class="font-medium transition-colors duration-300 hover:text-primary-900"
        >
          {{ navigationItem.name }}
        </div>
      </InertiaLink>
    ...
    >
      <div class="cursor-pointer font-medium hover:text-primary-600">
        {{ navigationItem.name }}
      </div>
          ...
          >
            ...
            >
              ...
              <InertiaLink :href="subMenuItem.url" v-smooth-scroll>
                <div
                  class="group flex items-center justify-between px-6 py-2 font-medium transition-all duration-500 hover:bg-primary-500"
                >
                  <!-- menu item name -->
                  <span
                    class="transition-all duration-300 group-hover:text-white"
                  >
                    {{ subMenuItem.name }}
                  </span>
                  <!-- menu item name -->
